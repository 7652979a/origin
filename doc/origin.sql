...
create table sys_dept (
                          ...
                          primary key (dept_id)
) engine=innodb  CHARSET=utf8mb4 auto_increment=200 comment = '部门表';

-- ----------------------------
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '伊始科技',   0, '伊始', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '厦门总公司', 1, '伊始', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '莆田分公司', 2, '伊始', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, '伊始', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '市场部门',   2, '伊始', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, '伊始', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, '伊始', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, '伊始', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, '伊始', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, '伊始', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
...
create table sys_user (
                          ...
                          primary key (user_id)
) engine=innodb  CHARSET=utf8mb4 auto_increment=100 comment = '用户信息表';

-- ----------------------------
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '伊始', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  105, 'ry',    '伊始', '00', 'ry@qq.com',  '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '测试员');
...
(
    ...
    remark        varchar(500)    default null               comment '备注',
    primary key (post_id)
) engine=innodb  CHARSET=utf8mb4 comment = '岗位信息表';
...
create table sys_role (
                          ...
                          remark               varchar(500)    default null               comment '备注',
                          primary key (role_id)
) engine=innodb  CHARSET=utf8mb4 auto_increment=100 comment = '角色信息表';
...
create table sys_menu (
                          ...
                          primary key (menu_id)
) engine=innodb  CHARSET=utf8mb4 auto_increment=2000 comment = '菜单权限表';
...
insert into sys_menu values('4', '伊始官网', '0', '4', 'http://origin.vip', null, '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate(), '', null, '伊始官网地址');
-- 二级菜单
...
) engine=innodb  CHARSET=utf8mb4 comment = '角色和部门关联表';
...
) engine=innodb  CHARSET=utf8mb4 comment = '用户与岗位关联表';
...
create table sys_oper_log (
                              ...
                              primary key (oper_id)
) engine=innodb  CHARSET=utf8mb4 auto_increment=100 comment = '操作日志记录';
...
(
    ...
    primary key (dict_id),
    unique (dict_type)
) engine=innodb  CHARSET=utf8mb4 auto_increment=100 comment = '字典类型表';
...
) engine=innodb  CHARSET=utf8mb4 auto_increment=100 comment = '字典数据表';
...
) engine=innodb  CHARSET=utf8mb4 auto_increment=100 comment = '参数配置表';
...
create table sys_logininfor (
                                ...
                                primary key (info_id)
) engine=innodb  CHARSET=utf8mb4 auto_increment=100 comment = '系统访问记录';
...
) engine=innodb  CHARSET=utf8mb4 auto_increment=100 comment = '定时任务调度表';
...
) engine=innodb  CHARSET=utf8mb4 comment = '定时任务调度日志表';
...
) engine=innodb  CHARSET=utf8mb4 auto_increment=10 comment = '通知公告表';

-- ----------------------------
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2018-07-01 伊始新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '维护通知：2018-07-01 伊始系统凌晨维护', '1', '维护内容',   '0', 'admin', sysdate(), '', null, '管理员');
...
) engine=innodb  CHARSET=utf8mb4 auto_increment=1 comment = '代码生成业务表';
...
) engine=innodb  CHARSET=utf8mb4 auto_increment=1 comment = '代码生成业务表字段';
